...
var telemetry_dojo_1 = require("telemetry/telemetry.dojo");
var Search_1 = require("esri/widgets/Search");
var Graphic_1 = require("esri/Graphic");
var Handles_1 = require("esri/core/Handles");
var lookupLayerUtils_1 = require("./utilites/lookupLayerUtils");
var esriWidgetUtils_1 = require("./utilites/esriWidgetUtils");
var errorUtils_1 = require("./utilites/errorUtils");
var watchUtils_1 = require("esri/core/watchUtils");
var DisplayLookupResults_1 = require("./components/DisplayLookupResults");
var Header_1 = require("./components/Header");
var Footer_1 = require("./components/Footer");
var MapPanel_1 = require("./components/MapPanel");
var i18n = require("dojo/i18n!./nls/resources");
var CSS = {
    loading: 'configurable-application--loading'
};
var domHelper_1 = require("ApplicationBase/support/domHelper");
var ConfigurationSettings_1 = require("./ConfigurationSettings");
var DetailPanel_1 = require("./components/DetailPanel");
var LookupGraphics = require("./components/LookupGraphics");
...
var LocationApp = /** @class */ (function () {
    ...
    LocationApp.prototype._setupFeatureSearch = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./components/RefineResults"); })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('esri/widgets/Directions'); })];
                    case 1:
                        Directions = _a.sent();
    ...
    LocationApp.prototype._createSharedTheme = function () {
        ...
        styles.push((header === null || header === void 0 ? void 0 : header.background) ?
            ...
            : null);
        styles.push((header === null || header === void 0 ? void 0 : header.text)
            ...
            : null);
        styles.push((button === null || button === void 0 ? void 0 : button.background)
            ...
            : null);
        styles.push((button === null || button === void 0 ? void 0 : button.text)
