...
define(["require", "exports", "esri/core/accessorSupport/decorators", "esri/core/Accessor", "esri/Graphic", "esri/core/Handles", "../utilites/geometryUtils", "esri/symbols", "../utilites/geometryUtils", "esri/Color", "esri/layers/FeatureLayer"], function (require, exports, decorators_1, Accessor, Graphic_1, Handles_1, geometryUtils_1, symbols_1, geometryUtils_2, Color_1, FeatureLayer_1) {
    "use strict";
    ...
    var LookupGraphics = /** @class */ (function (_super) {
        ...
        LookupGraphics.prototype._createBufferGraphic = function () {
            return __awaiter(this, void 0, void 0, function () {
                var fillColor, fillSymbol, geometry;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this._createBuffer(this.graphic.geometry)];
                        case 1:
                            geometry = _a.sent();
                            this._bufferGraphic = new Graphic_1.default({
                                geometry: geometry,
                                symbol: fillSymbol
                            });
        ...
        LookupGraphics.prototype._removeBuffer = function () {
            if (this._bufferGraphic)
        ...
        LookupGraphics.prototype._createBuffer = function (location) {
        ...
        LookupGraphics.prototype._updateTheme = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, geometryUtils_2.getBasemapTheme(this.view)];
                        case 1:
                            theme = _a.sent();
